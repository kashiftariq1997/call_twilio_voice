...
public class SwiftTwilioVoicePlugin: NSObject, FlutterPlugin,  FlutterStreamHandler, PKPushRegistryDelegate, NotificationDelegate, CallDelegate, AVAudioPlayerDelegate, CXProviderDelegate {
    ...
    public override init() {
        ...
        let registrar = controller.registrar(forPlugin: "twilio_voice_t")
        if let unwrappedRegistrar = registrar {
            let eventChannel = FlutterEventChannel(name: "twilio_voice_t/events", binaryMessenger: unwrappedRegistrar.messenger())
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let methodChannel = FlutterMethodChannel(name: "twilio_voice_t/messages", binaryMessenger: registrar.messenger())
        let eventChannel = FlutterEventChannel(name: "twilio_voice_t/events", binaryMessenger: registrar.messenger())
