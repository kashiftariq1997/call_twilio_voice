...
public class SwiftTwilioVoicePlugin: NSObject, FlutterPlugin,  FlutterStreamHandler, PKPushRegistryDelegate, NotificationDelegate, CallDelegate, AVAudioPlayerDelegate, CXProviderDelegate {
    ...
    public override init() {
        ...
        let registrar = controller.registrar(forPlugin: "call_twilio_voice")
        if let unwrappedRegistrar = registrar {
            let eventChannel = FlutterEventChannel(name: "call_twilio_voice/events", binaryMessenger: unwrappedRegistrar.messenger())
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let methodChannel = FlutterMethodChannel(name: "call_twilio_voice/messages", binaryMessenger: registrar.messenger())
        let eventChannel = FlutterEventChannel(name: "call_twilio_voice/events", binaryMessenger: registrar.messenger())
